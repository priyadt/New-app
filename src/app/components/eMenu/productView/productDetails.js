...
  }
  ...
  termMilageChangeEvent(selectIndex, typ, lineFrom , eventValue = null, definedRatesArr=[]) {
    ...
    this.setState(newState , () => {
      ...
      this.updatePrice(this.state, this.props,'termMilage', false,true, selectIndex, stateDeductibleIndex, userPrefInfo);
    })
  }
  }
  ...
        let cost = (userPrefernceInfo && !isEventUpdated) ? userPrefernceInfo.cost : this.getCost(rate, termMilageIndex, deductibleIndex, deductible, packageOption);
        let price = {};
